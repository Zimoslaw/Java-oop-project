...
public class AddDuchyViewController {
    @FXML
    ...
    protected void Submit() {
        ...
        {
            Duchy duchy = new Duchy(name.getText(), ruler.getValue(), provinces.getSelectionModel().getSelectedItems(), centralization.getValue());
            database.add(duchy);
            infos.setText("Dodałeś Księstwo:\n"+duchy.ToString());
        }
        else
